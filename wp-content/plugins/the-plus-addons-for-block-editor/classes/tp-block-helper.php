	...
	*/
	...
	public static function tpgb_flex_child_css($flexChild  , $selector){
		...
		foreach($flexChild as $index => $item){
			...
			$flexChildCss .= ( isset($item['flexShrink']['md']) && !empty($item['flexShrink']['md']) ) ? $childSele.'{ flex-shrink : '.$item['flexShrink']['md'].' }' : '' ;
			$flexChildCss .= ( isset($item['flexGrow']['md']) && !empty($item['flexGrow']['md']) ) ? $childSele.'{ flex-grow : '.$item['flexGrow']['md'].' }' : '' ;
			$flexChildCss .= ( isset($item['flexBasis']['md']) && !empty($item['flexBasis']['md']) ) ? $childSele.'{ flex-basis : '.$item['flexBasis']['md'].$item['flexBasis']['unit'].' }' : '' ;
			$flexChildCss .= ( isset($item['flexselfAlign']['md']) && !empty($item['flexselfAlign']['md']) ) ? $childSele.'{ align-self : '.$item['flexselfAlign']['md'].' }' : '' ;
			$flexChildCss .= ( isset($item['flexOrder']['md']) && !empty($item['flexOrder']['md']) ) ? $childSele.'{ order : '.$item['flexOrder']['md'].' }' : '' ;
			
			//Tablet Css
			if( isset($item['flexShrink']['sm']) && !empty($item['flexShrink']['sm']) ){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-shrink : '.$item['flexShrink']['sm'].' } }';
			} else if( isset($item['flexShrink']['md']) && !empty($item['flexShrink']['md']) ){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-shrink : '.$item['flexShrink']['md'].' } }';
			}

			if(isset($item['flexGrow']['sm']) && !empty($item['flexGrow']['sm'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-grow : '.$item['flexGrow']['sm'].' } }';
			} else if(isset($item['flexGrow']['md']) && !empty($item['flexGrow']['md'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-grow : '.$item['flexGrow']['md'].' } }';
			}

			if(isset($item['flexBasis']['sm']) && !empty($item['flexBasis']['sm'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-basis : '.$item['flexBasis']['sm'].$item['flexBasis']['unit'].' } }';
			}else if(isset($item['flexBasis']['md']) && !empty($item['flexBasis']['md'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ flex-basis : '.$item['flexBasis']['md'].$item['flexBasis']['unit'].' } }';
			}

			if(isset($item['flexselfAlign']['sm']) && !empty($item['flexselfAlign']['sm'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ align-self: '.$item['flexselfAlign']['sm'].' } }';
			}else if(isset($item['flexselfAlign']['md']) && !empty($item['flexselfAlign']['md'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ align-self: '.$item['flexselfAlign']['md'].' } }';
			}


			if(isset($item['flexOrder']['sm']) && !empty($item['flexOrder']['sm'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ order : '.$item['flexOrder']['sm'].' } }';
			}else if(isset($item['flexOrder']['md']) && !empty($item['flexOrder']['md'])){
				$flexChildCss .= '@media (max-width: 1024px) {'.$childSele.'{ order : '.$item['flexOrder']['md'].' } }';
			}

			// moblie Css
			if( isset($item['flexShrink']['xs']) && !empty($item['flexShrink']['xs']) ){
				$flexChildCss .= '@media (max-width: 767px) {'.$childSele.'{ flex-shrink : '.$item['flexShrink']['xs'].' } }';
			}else if( isset($item['flexShrink']['sm']) && !empty($item['flexShrink']['sm']) ){
			...
			if( isset($item['flexGrow']['xs']) && !empty($item['flexGrow']['xs']) ){
				$flexChildCss .= '@media (max-width: 767px) {'.$childSele.'{ flex-grow : '.$item['flexGrow']['xs'].' } }';
			}else if(isset($item['flexGrow']['sm']) && !empty($item['flexGrow']['sm'])){
			...
			if(isset($item['flexBasis']['xs']) && !empty($item['flexBasis']['xs'])){
				$flexChildCss .= '@media (max-width: 767px) {'.$childSele.'{ flex-basis : '.$item['flexBasis']['xs'].$item['flexBasis']['unit'].' } }';
			}else if(isset($item['flexBasis']['sm']) && !empty($item['flexBasis']['sm'])){
			...
			if(isset($item['flexOrder']['xs']) && !empty($item['flexOrder']['xs'])){
				$flexChildCss .= '@media (max-width: 767px) {'.$childSele.'{ order : '.$item['flexOrder']['xs'].' } }';
			}else if(isset($item['flexOrder']['sm']) && !empty($item['flexOrder']['sm'])){
			...
			if( isset($item['flexselfAlign']['xs']) && !empty($item['flexselfAlign']['xs'])){
				$flexChildCss .= '@media (max-width: 767px) {'.$childSele.'{ align-self: '.$item['flexselfAlign']['xs'].' } }';
			}else if(isset($item['flexselfAlign']['sm']) && !empty($item['flexselfAlign']['sm'])){
