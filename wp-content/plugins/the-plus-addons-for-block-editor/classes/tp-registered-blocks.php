...
function tpgb_registered_blocks(){
	...
	$load_blocks_css_js = [
		...
		TPGB_CATEGORY.'/tp-container' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-container/style.css',
				],
			],
		],
		TPGB_CATEGORY.'/tp-container-inner' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-container-inner/style.css',
				],
			],
		],
		TPGB_CATEGORY.'/tp-code-highlighter' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-code-highlighter/style.css',
				],
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/code-highlighter/tpgb-code-highlighter.js',
				],
			],
		],
		...
		TPGB_CATEGORY.'/tp-accordion' => [
			'dependency' => [
				...
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/main/common-created/tpgb-slidetoggle-block.min.js',
		...
		TPGB_CATEGORY.'/tp-messagebox' => [
			'dependency' => [
				...
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/main/common-created/tpgb-slidetoggle-block.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/messagebox/tpgb-messagebox.min.js',
				],
			],
		],
		...
		'tp-heading-title-split' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/jquery.waypoints.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/splittext.min.js',					
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/tweenmax/tweenmax.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/main/heading-title/tpgb-heading-title.min.js',
				],
			],
		],
		...
		TPGB_CATEGORY.'/tp-interactive-circle-info' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-interactive-circle-info/style.css',
				],
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/interactive-circle-info/tpgb-interactive-circle-info.min.js',
				],
			],
		],
		...
		TPGB_CATEGORY.'/tp-social-icons' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/css/extra/tippy.css',
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-social-icons/style.css',
				],
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/popper.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/tippy.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/main/social-icons/tpgb-social-icons.min.js',
				],
			],
		],
		TPGB_CATEGORY.'/tp-social-feed' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/css/extra/jquery.fancybox.min.css',
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/css/extra/bootstrap-grid.min.css',
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-social-feed/style.css',
				],
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/extra/jquery.fancybox.min.js',
					...
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/social-feed/tp-social-feed.min.js',
				],			
			],
		],
		TPGB_CATEGORY.'/tp-social-reviews' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/css/extra/bootstrap-grid.min.css',
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-social-reviews/style.css',
				],
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/extra/isotope.pkgd.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/post-listing/post-masonry.min.js',
					TPGB_PATH . DIRECTORY_SEPARATOR . 'assets/js/main/social-reviews/tp-social-reviews.min.js',
				],
			],
		],
		...
		TPGB_CATEGORY.'/tp-social-embed' => [
			'dependency' => [
				'css' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'classes/blocks/tp-social-embed/style.css',
				],		
			],
		],
		...
		'prism_default' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-default.js',
				],
			],
		],
		'prism_coy' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-coy.js',
				],
			],
		],
		'prism_dark' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-dark.js',
				],
			],
		],
		'prism_funky' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-funky.js',
				],
			],
		],
		'prism_okaidia' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-okaidia.js',
				],
			],
		],
		'prism_solarizedlight' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-solarizedlight.js',
				],
			],
		],
		'prism_tomorrownight' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-tomorrownight.js',
				],
			],
		],
		'prism_twilight' => [
			'dependency' => [
				'js' => [
					TPGB_PATH . DIRECTORY_SEPARATOR .'assets/js/extra/code-highlighter/prism-twilight.js',
				],
			],
		],
	];
...
Class Tpgb_Library {
    ...
    public function get_plus_block_settings($block = null){
		...
		$plus_extras = array('content-hover-effect','tpgb-group-button','carouselSlider','countdown-style-1','tpgb-animation', 'tpgb-pagination', 'tpgb-caldera-form', 'tpgb-everest-form', 'tpgb-gravity-form', 'tpgb-wp-form', 'tpgb-draw-svg', 'tpgb-fancy-box', 'tpgb-row-column-link','tp-heading-title-split', 'prism_default', 'prism_coy','prism_dark', 'prism_funky', 'prism_okaidia', 'prism_solarizedlight', 'prism_tomorrownight', 'prism_twilight');
    ...
    public function check_css_js_cache_files($post_type = null, $post_id = null, $type = 'css')
    {
		...
		if($type == 'css'){
			$css_url = TPGB_ASSET_PATH . DIRECTORY_SEPARATOR . ($post_type ? 'theplus-' . $post_type : 'theplus') . (isset($post_id) ? '-' . $post_id : '') . '.min.css';
			if ( is_readable( $this->secure_path_url($css_url) ) ) {
				return true;
			}
		}else if($type == 'js'){
			$js_url = TPGB_ASSET_PATH . DIRECTORY_SEPARATOR . ($post_type ? 'theplus-' . $post_type : 'theplus') . (isset($post_id) ? '-' . $post_id : '') . '.min.js';
			if ( is_readable( $this->secure_path_url($js_url) ) || $this->requires_update ) {
				return true;
			}
		}
		return false;
	...
	/*
	 * Load Template Post Id Dynamic Enqueue Css
	 */
	public function wp_footer(){
		...
		foreach($template_post_id as $post_id){
			...
			if (file_exists($css_path)) {
				...
				wp_enqueue_style("plus-post-{$post_id}", $this->pathurl_security($css_url), false, $plus_version);
    ...
    public function generate_scripts_frontend() {
        ...
        if (is_home() || is_singular() || is_archive() || is_search() || (isset( $wp_query ) && (bool) $wp_query->is_posts_page) || is_404()) {
			...
			if(isset($wp_query->is_post_type_archive) && !empty($wp_query->is_post_type_archive)){
				$queried_object = $wp_query->query['post_type'];
			}
			if(is_search()){
			...
			$tpgb_url = TPGB_URL;
			$plus_version=get_post_meta( $queried_object, '_block_css', true );
			if(empty($plus_version)){
				$plus_version=time();
			}
			
			if($this->get_caching_option() && !empty($elements)){
				...
				if(isset($separate_path['css']) && !empty($separate_path['css'])){
					...
					foreach( $separate_path['css'] as $key => $path ){
						if(is_readable($this->secure_path_url($path))){
							...
							$enq_name = 'theplus-'.$css_file_key.'-'.$iji;
							if($iji === $total_eng){
				...
				if ( class_exists( 'Tp_Core_Init_Blocks' ) ) {
					...
					if ( !empty($load_enqueue) && is_callable( array( $load_enqueue, 'enqueue_load_block_css_js' ) ) ) {
						$load_enqueue->enqueue_load_block_css_js( true );
					}
				}
				if(isset($separate_path['js']) && !empty($separate_path['js'])){
					foreach( $separate_path['js'] as $key => $path ){
						if(is_readable($this->secure_path_url($path))){
							...
							wp_enqueue_script('theplus-'.$js_file_key,$this->pathurl_security($js_sep_url), ['jquery'], $plus_version,true);
						}
					}
				}
			}
	...
	public function enqueue_frontend_load($post_type, $queried_obj) {
		...
		if (!$this->is_preview_mode()) {
			...
			if ($this->requires_update) {
				...
				if($this->get_caching_option()){ //separate file			
					$separate_path = $this->load_separate_file($elements);				
					$this->remove_files_unlink($post_type, $queried_obj);
				}else{ //combine
			...
			if(empty($plus_version) && gettype($queried_obj)){
				$plus_version = TPGB_VERSION;
			...
			if( isset($_GET['preview']) && $_GET['preview'] == true){
				...
				if (file_exists($global_path) && !$this->is_editor_screen()) {
					...
					wp_enqueue_style("plus-global-preview", $this->pathurl_security($global_url), false, $plus_version);
			...
			if($this->get_caching_option() && !empty($separate_path)){
				...
				if(isset($separate_path['js']) && !empty($separate_path['js'])){
					...
					foreach( $separate_path['js'] as $key => $path ){
						if(is_readable($this->secure_path_url($path))){
							...
							wp_enqueue_script('theplus-'.$js_file_key,$this->pathurl_security($js_sep_url), $load_comp, $plus_version,true);
							$iji++;
						}
					}
				}
				...
				if( $this->check_css_js_cache_files($post_type, $queried_obj, 'js') ){
					wp_enqueue_script('tpgb-plus-block-front-js', $this->pathurl_security($js_file), $load_comp, $plus_version, true);
	...
	public function plus_blocks_options($options='' , $blockname=''){
		...
		if($blockname=='tpgb/tp-heading-title' && !empty($options) && (!empty($options['style']) && $options['style']=='style-9')){
			$this->transient_blocks[] = 'tp-heading-title-split';
		}
		...
		if($blockname=='tpgb/tp-code-highlighter') {
			if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-coy'){ //prism_coy
			   $this->transient_blocks[] = 'prism_coy';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-dark'){ //prism_dark
			   $this->transient_blocks[] = 'prism_dark';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-funky'){ //prism_funky
			   $this->transient_blocks[] = 'prism_funky';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-okaidia'){ //prism_okaidia
			   $this->transient_blocks[] = 'prism_okaidia';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-solarizedlight'){ //prism_solarizedlight
			   $this->transient_blocks[] = 'prism_solarizedlight';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-tomorrownight'){ //prism_tomorrownight
			   $this->transient_blocks[] = 'prism_tomorrownight';
		   }else if(!empty($options) && !empty($options['themeType']) && $options['themeType'] == 'prism-twilight'){ //prism_twilight
			   $this->transient_blocks[] = 'prism_twilight';
		   }else{
			   $this->transient_blocks[] = 'prism_default';
		   }
	   }
