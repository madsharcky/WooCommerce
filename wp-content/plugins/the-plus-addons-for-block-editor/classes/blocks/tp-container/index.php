...
function tpgb_tp_container_render_callback( $attributes, $content) {
	...
	if(!empty($showchild) ){
		if(!empty($flexChild)){
			$flexChildCss = Tp_Blocks_Helper::tpgb_flex_child_css( $flexChild , '.tpgb-block-'.esc_attr($block_id).'.tpgb-container-row .tpgb-container-col:nth-child'  );
		}
	}

	$output .= '<div '.$customId.' class="tpgb-container-row tpgb-block-'.esc_attr($block_id).' '.esc_attr($sectionClass).' '.esc_attr($customClass).' '.esc_attr($blockClass).' '.($colDir == 'c100' || $colDir == 'r100' ? ' tpgb-container-inline' : '').'  tpgb-container-'.$contentWidth.' " data-id="'.esc_attr($block_id).'" '.$linkdata.' >';
		$output .= $content;
	$output .= "</div>";
				...
				'repeaterField' => [
					(object) [
						'flexShrink' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-row,{{PLUS_WRAP}}.tpgb-container-row-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-shrink : {{flexShrink}} }',
								],
							],
						],
						'flexGrow' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-row,{{PLUS_WRAP}}.tpgb-container-row-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-grow : {{flexGrow}} }',
								],
							],
						],
						'flexBasis' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-row,{{PLUS_WRAP}}.tpgb-container-row-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-basis : {{flexBasis}}% }',
								],
							],
						],
						'flexselfAlign' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-row,{{PLUS_WRAP}}.tpgb-container-row-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ align-self : {{flexselfAlign}} }',
								],
							],
							'scopy' => true,
						],
						'flexOrder' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-row,{{PLUS_WRAP}}.tpgb-container-row-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ order : {{flexOrder}} }',
								],
							],
							'scopy' => true,
						],
