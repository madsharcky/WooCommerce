...
function tpgb_tp_interactive_circle_info_render_callback( $attributes, $content) {
	...
	if(!empty($outAnimation)){
		$animationClass = 'interactive-circle-animation-'.$selAnimation;
	}
	...
	$output = '';
    $output .= '<div class="tpgb-interactive-circle-info circle-'.esc_attr($styleType).' '.esc_attr($animationClass).' '.esc_attr($indicatClass).' '.esc_attr($contiRotateClass).' tpgb-block-'.esc_attr($block_id).' '.esc_attr($blockClass).'" data-trigger="'.esc_attr($mouseTrigger).'" '.$dAutoTimeAttr.' id="'.esc_attr($connect_id).'" data-connection="'.esc_attr($connect_carousel).'" data-eventtype="'.esc_attr($connection_hover_click).'">';
		$output .= '<div class="interactive-circle-wrap">';
			$output .= '<div class="interactive-circle-inner-wrap" data-total="'.esc_attr($totalItems).'">';
				$output .= '<div class="interactive-circle-inner">';
					foreach ( $intCircle as $index => $item ):
						$itemCount = $defActive = '';
						...
						$output .= '<div class="tpgb-interactive-circle-item tpgb-circle-item-'.esc_attr($itemCount).' tp-repeater-item-'.esc_attr($item['_key']).' '.esc_attr($defActive).'" data-index="'.esc_attr($itemCount).'">';
							$output .= '<div class="tpgb-circle-icon-wrap">';
								$output .= '<div class="circle-icon-inner">';
							...
							$output .= '</div>';
							$output .= '<div class="tpgb-circle-content-wrap">';
								$output .= '<div class="circle-content-inner">';
...
function tpgb_tp_interactive_circle_info() {
	...
	$attributesOptions = array(
				...
				(object) [
					...
					'iconAColor' => [
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'iconType', 'relation' => '==', 'value' => 'icon']],
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item{{TP_REPEAT_ID}}.active .tpgb-in-circle-icon{ color: {{iconAColor}}; }',
							],
						],
						'scopy' => true,
					],
					...
					'iTitleAColor' => [
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'iconTitle', 'relation' => '!=', 'value' => '']],
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item{{TP_REPEAT_ID}}.active .circle-icon-title{ color: {{iTitleAColor}}; }',
							],
						],
						'scopy' => true,
					],
					'iconNBG' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap {{TP_REPEAT_ID}} .tpgb-circle-icon-wrap',
							],
						],
						'scopy' => true,
					],
					'iconHBG' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap {{TP_REPEAT_ID}} .tpgb-circle-icon-wrap:hover',
							],
						],
						'scopy' => true,
					],
					'iconABG' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item{{TP_REPEAT_ID}}.active .tpgb-circle-icon-wrap',
							],
						],
						'scopy' => true,
					],
					...
					'iconABcolor' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item{{TP_REPEAT_ID}}.active .tpgb-circle-icon-wrap { border-color: {{iconABcolor}}; }',
							],
						],
						'scopy' => true,
					],
		...
		'Alignment' => [
			...
			'style' => [
				(object) [
					'condition' => [(object) ['key' => 'Alignment', 'relation' => '==', 'value' => 'left' ]],
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap{ justify-content: flex-start; }',
				],
				(object) [
					'condition' => [(object) ['key' => 'Alignment', 'relation' => '==', 'value' => 'center' ]],
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap{ justify-content: center; }',
				],
				(object) [
					'condition' => [(object) ['key' => 'Alignment', 'relation' => '==', 'value' => 'right' ]],
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap{ justify-content: flex-end; }',
				],
			],
			'scopy' => true,
		],
		...
		'circleWidth' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-inner{ width: {{circleWidth}}; height: {{circleWidth}}; }',
				],
			],
			'scopy' => true,
		],
		'circleNBG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-inner',
				],
			],
			'scopy' => true,
		],
		'circleHBG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-inner:hover',
				],
			],
			'scopy' => true,
		],
		...
		'circleNRadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-inner {border-radius: {{circleNRadius}};}',
				],
			],
			'scopy' => true,
		],
		'circleHRadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-inner:hover {border-radius: {{circleHRadius}};}',
				],
			],
			'scopy' => true,
		],
		...
		'iconWidth' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap .tpgb-circle-icon-wrap{ width: {{iconWidth}}; height: {{iconWidth}}; }',
				],
			],
			'scopy' => true,
		],
		...
		'iconAColor' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .tpgb-in-circle-icon{ color: {{iconAColor}}; }',
				],
			],
			'scopy' => true,
		],
		...
		'iTitleAColor' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-icon-title{ color: {{iTitleAColor}}; }',
				],
			],
			'scopy' => true,
		],
		'iconNBG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap .tpgb-circle-icon-wrap',
				],
			],
			'scopy' => true,
		],
		'iconHBG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap .tpgb-circle-icon-wrap:hover',
				],
			],
			'scopy' => true,
		],
		'iconABG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .tpgb-circle-icon-wrap',
				],
			],
			'scopy' => true,
		],
		...
		'iconNRadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap .tpgb-circle-icon-wrap {border-radius: {{iconNRadius}};}',
				],
			],
			'scopy' => true,
		],
		'iconHRadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .interactive-circle-wrap .tpgb-circle-icon-wrap:hover {border-radius: {{iconNRadius}};}',
				],
			],
			'scopy' => true,
		],
		'iconARadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .tpgb-circle-icon-wrap {border-radius: {{iconARadius}};}',
				],
			],
			'scopy' => true,
		],
		...
		'cTitleAColor' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-content-title{ color: {{cTitleAColor}}; }',
				],
			],
			'scopy' => true,
		],
		...
		'cDescAColor' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-content-desc { color: {{cDescAColor}}; }',
				],
			],
			'scopy' => true,
		],
		...
		'contentABG' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-content-inner',
				],
			],
			'scopy' => true,
		],
		...
		'contentARadius' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-content-inner, {{PLUS_WRAP}}.circle-style-1 .tpgb-interactive-circle-item.active .tpgb-circle-content-wrap {border-radius: {{contentARadius}};}',
				],
			],
			'scopy' => true,
		],
		...
		'contentAShadow' => [
			...
			'style' => [
				(object) [
					'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .circle-content-inner, {{PLUS_WRAP}}.circle-style-1 .tpgb-interactive-circle-item.active .tpgb-circle-content-wrap',
				],
			],
			'scopy' => true,
		],
			...
			'groupField' => [
				(object) [
					...
					'lineAColor' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .tpgb-circle-ext-indicator .tpgb-circle-shape-wrap { background: {{lineAColor}}; }',
							],
						],
						'scopy' => true,
					],
					...
					'edgeAColor' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}} .tpgb-interactive-circle-item.active .tpgb-circle-ext-indicator .tpgb-circle-shape-inner { background: {{edgeAColor}}; }',
							],
						],
						'scopy' => true,
					],
					...
					'dotAColor' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}}.indicator-style-5 .tpgb-interactive-circle-item.active .tpgb-circle-ext-indicator .tpgb-circle-shape-wrap::before { background: {{dotAColor}}; }',
							],
						],
						'scopy' => true,
					],
					...
					'circleAColor' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}}.indicator-style-5 .tpgb-interactive-circle-item.active .tpgb-circle-ext-indicator .tpgb-circle-shape-inner { border-color: {{circleAColor}}; }',
							],
						],
						'scopy' => true,
					],
			...
			'groupField' => [
				(object) [
					...
					'contiRotateSpeed' => [
						...
						'style' => [
							(object) [
								'selector' => '{{PLUS_WRAP}}.circle-continue-rotate .interactive-circle-inner, {{PLUS_WRAP}}.circle-continue-rotate .interactive-circle-inner .tpgb-circle-icon-wrap .circle-icon-inner, {{PLUS_WRAP}}.circle-continue-rotate .interactive-circle-inner .tpgb-circle-content-wrap { animation-duration: {{contiRotateSpeed}}; -moz-animation-duration: {{contiRotateSpeed}}; -webkit-animation-duration: {{contiRotateSpeed}}; }',
							],
						],
						'scopy' => true,
					],
