...
function tpgb_button_render_callback( $attributes ) {
	...
	$getButtonSource='';
		...
		if($styleType=='style-23'){
			if($icnVrtcal=='icon-top'){
				$getButtonSource .='<span class="button-tag-hint">';
					if($iconType=='fontAwesome' && $iconPosition=='iconBefore'){
						$getButtonSource .= $getBfrIcon;
					}
						$getButtonSource .= wp_kses_post($btnTagText);
					if($iconType=='fontAwesome' && $iconPosition=='iconAfter'){
		...
		if($styleType=='style-7'){
			$getButtonSource .='<span class="btn-arrow"><span class="btn-right-arrow"><i class="fas fa-chevron-right"></i></span></span>';
		}
		if($styleType=='style-9'){
			$getButtonSource .='<span class="btn-arrow">';
    ...
    $output .= '<div class="tpgb-plus-button tpgb-block-'.esc_attr($block_id).' button-'.esc_attr($styleType).' '.esc_attr($iconHover).' '.esc_attr($blockClass).' ">';
		$output .='<div class="animted-content-inner'.esc_attr($contentHvrClass).'">';
			$output .='<a href="'.esc_url($btnLink).'" target="'.esc_attr($target).'" rel="'.esc_attr($nofollow).'" class="button-link-wrap '.esc_attr($IShakeAnimate).' '.esc_attr($s23VrtclCntr).'" role="button" data-hover="'.wp_kses_post($hoverText).'" '.$link_attr.'>';
				if($styleType != 'style-17' && $styleType != 'style-23'){
	...
	$attributesOptions = array(
			...
			'btnTextNmlColor' => [
				...
				'style' => [
					...
					(object) [
						...
						'selector' => '{{PLUS_WRAP}}.tpgb-plus-button.button-style-7 .button-link-wrap .btn-arrow{ color: {{btnTextNmlColor}}; }
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-7 .button-link-wrap:after{ border-color: {{btnTextNmlColor}};}',
					],
					(object) [
			...
			'iconNmlColor' => [
				...
				'style' => [
					...
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '==', 'value' => 'style-7' ]],
						'selector' => '{{PLUS_WRAP}}.tpgb-plus-button.button-style-7 .button-link-wrap .btn-arrow{ color: {{iconNmlColor}}; }
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-7 .button-link-wrap:after{ border-color: {{iconNmlColor}};}',
					],
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '==', 'value' => 'style-9' ]],
			...
			'btnTextHvrColor' => [
				...
				'style' => [
					(object) [
						...
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-14 .button-link-wrap::after{ color: {{btnTextHvrColor}}; }',
					],
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '!=', 'value' => ['style-3','style-6','style-7','style-9'] ],['key' => 'iconType', 'relation' => '==', 'value' => 'fontAwesome' ]],
			...
			'BHoverColor' => [
				...
				'style' => [
					(object) [
						...
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-18 .button-link-wrap::before{ background: {{BHoverColor}}; }',
					],
				],
				'scopy' => true,
			],
			'hoverBG' => [
				...
				'style' => [
					...
					(object) [
						...
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-5 .button-link-wrap:before,
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-5 .button-link-wrap:after',
					],
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '==', 'value' => 'style-8' ]],
					...
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '==', 'value' => 'style-13' ]],
						'selector' => '{{PLUS_WRAP}}.tpgb-plus-button.button-style-13 .button-link-wrap::before ,
						{{PLUS_WRAP}}.tpgb-plus-button.button-style-13 .button-link-wrap::after',
					],
					(object) [
						'condition' => [(object) ['key' => 'styleType', 'relation' => '==', 'value' => 'style-14' ]],
