...
function tpgb_tp_grid_render_callback( $attributes, $content) {
	...
	if(!empty($showchild) ){
		if(!empty($flexChild)){
			$flexChildCss = Tp_Blocks_Helper::tpgb_flex_child_css( $flexChild , '.tpgb-block-'.esc_attr($block_id).'.tpgb-container-col div:nth-child' );
		}
	}
...
function tpgb_tp_grid() {
	...
	$attributesOptions = [
			...
			'minHeight' => [
				...
				'style' => [
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout,{{PLUS_WRAP}}.tpgb-container-col{ height: {{minHeight}}; }',
					],
				],
			],
			'NormalBg' => [
			...
			'hideMobile' => [
				...
				'style' => [
					(object) [
						'selector' => '@media (max-width: 1024px){.text-center{text-align: center;}}@media (max-width: 767px){ .edit-post-visual-editor {{PLUS_WRAP}}{display: block;opacity: .5;} {{PLUS_WRAP}}{ display:none !important; } }',
					],
				],
				'scopy' => true,
			],
			...
			'flexDirection' => [
				...
				'style' => [
					(object) [
						...
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-direction: {{flexDirection}} }',
					],
					(object) [
						'condition' => [ (object) ['key' => 'flexreverse', 'relation' => '==', 'value' => true]],
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-direction: {{flexDirection}}-reverse }',
					],
				],
				'scopy' => true,
			],
			'flexAlign' => [
				...
				'style' => [
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ align-items : {{flexAlign}} }',
					],
				],
				'scopy' => true,
			],
			'flexJustify' => [
				...
				'style' => [
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ justify-content : {{flexJustify}} }',
					],
				],
				'scopy' => true,
			],
			'flexGap' => [
				...
				'style' => [
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ gap : {{flexGap}} }',
					],
				],
				'scopy' => true,
			],
			'flexwrap' => [
				...
				'style' => [
					(object) [
						...
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-wrap : {{flexwrap}} }',
					],
					(object) [
						'condition' => [ (object) ['key' => 'reverseWrap', 'relation' => '==', 'value' => true]],
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-wrap : {{flexwrap}}-reverse }',
					],
				],
				'scopy' => true,
			],
			'alignWrap' => [
				...
				'style' => [
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ align-content : {{alignWrap}} }',
					],
				],
				'scopy' => true,
			],
				...
				'repeaterField' => [
					(object) [
						'flexShrink' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-shrink : {{flexShrink}} }',
								],
							],
						],
						'flexGrow' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-grow : {{flexGrow}} }',
								],
							],
						],
						'flexBasis' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ flex-basis : {{flexBasis}}% }',
								],
							],
						],
						'flexselfAlign' => [
							...
							'style' => [
								(object) [
									'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ align-self : {{flexselfAlign}} }',
								],
							],
							'scopy' => true,
						],
						'flexOrder' => [
							...
							'style' => [
								(object) [ 
									'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col-editor > .block-editor-inner-blocks > .block-editor-block-list__layout{ order : {{flexOrder}} }',
								],
							],
							'scopy' => true,
						],
