...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	$Iconlogo = '<div class="tpgb-sf-logo">
					<a href="'.esc_url($PostLink).'" class="tpgb-sf-logo-link" target="_blank" rel="noopener noreferrer" >
	...
	ob_start();
    	echo '<div class="tpgb-sf-header">';
    		if(!empty($UserImage)){
    			echo '<div class="tpgb-sf-profile"><img class="tpgb-sf-logo" src="'.esc_url($UserImage).'"/></div>';
    		} 
